 ...
 * media_definitions.h
 * ---------------------------------------------------------------------------
 * Defines the variables, constant variables and interfaces.
 * ---------------------------------------------------------------------------
 * Reference implementation: mediadefinitions.h (Erizo)
 */

#ifndef MEDIA_DEFINITIONS_H_
#define MEDIA_DEFINITIONS_H_
...
struct dataPacket{
  ...
  int64_t remote_ntp_time_ms = -1;
  int arrival_time_ms = -1;
