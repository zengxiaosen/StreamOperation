 ...
 * --------------------------------------------------------------------------
 * recordio.h
 * -- defines the classes for reading and writting ProtocolBuffer object into
 *    recordio files.
 *
...
#ifndef ORBIT_BASE_RECORDIO_H__
#define ORBIT_BASE_RECORDIO_H__
